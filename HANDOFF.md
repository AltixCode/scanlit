...
| | State | Id |
|---|---|---|
| Bundle id registered | ✅ | `com.altixcode.scanlit` |
| App Store Connect record | ✅ | `6812380808` — store name "Scanlit" |
...
| AdMob app — iOS | ✅ | `ca-app-pub-2504845459806550~6718687637` |
| AdMob app — Android | ✅ | `ca-app-pub-2504845459806550~7606237205` |
| AdMob ad units (6) | ✅ | iOS banner/interstitial/rewarded `6194662196` / `4911791109` / `3598709433`; Android `1970767142` / `9657685472` / `7457054236` |
...
| RevenueCat project, apps, entitlement, offering | ✅ | project `proj40c27060`, entitlement `entled767d605e`, offering `ofrng4d786852e8` |
