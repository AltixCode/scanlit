...
`apps.json`). Fix it there and re-run `node scripts/bootstrap.mjs scanlit`,
...
| | |
|---|---|
| Bundle id / package | `com.altixcode.scanlit` |
| Scheme | `scanlit://` |
| RevenueCat entitlement | `remove_ads` |
| RevenueCat package | `$rc_lifetime` |
| iOS product | `com.altixcode.scanlit.removeads` |
| Android product | `remove_ads` |
| GitHub | `AltixCode/scanlit` |
